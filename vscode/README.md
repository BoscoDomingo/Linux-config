...
mv "~\AppData\Roaming\Cursor\User\settings.json" "~\AppData\Roaming\Cursor\User\settings.backup.json"
mv "~\AppData\Roaming\Cursor\User\keybindings.json" "~\AppData\Roaming\Cursor\User\keybindings.backup.json"
mv "~\.cursor\extensions\extensions.json" "~\.cursor\extensions\extensions.backup.json"
New-Item -Path "~\AppData\Roaming\Cursor\User\settings.json" -ItemType SymbolicLink -Value "$LinuxConfigPath\vscode\settings.json"
New-Item -Path "~\AppData\Roaming\Cursor\User\keybindings.json" -ItemType SymbolicLink -Value "$LinuxConfigPath\vscode\keybindings.json"
New-Item -Path "~\.cursor\extensions\extensions.json" -ItemType SymbolicLink -Value "$LinuxConfigPath\vscode\extensions-cursor.json"

# VS Code
$LinuxConfigPath = "\\wsl.localhost\archlinux\home\bosco\dotfiles"
mv "~\AppData\Roaming\Code\User\settings.json" "~\AppData\Roaming\Code\User\settings.backup.json"
mv "~\AppData\Roaming\Code\User\keybindings.json" "~\AppData\Roaming\Code\User\keybindings.backup.json"
New-Item -Path "~\AppData\Roaming\Code\User\settings.json" -ItemType SymbolicLink -Value "$LinuxConfigPath\vscode\settings.json"
New-Item -Path "~\AppData\Roaming\Code\User\keybindings.json" -ItemType SymbolicLink -Value "$LinuxConfigPath\vscode\keybindings.json"
```
...
ln -s $LinuxConfigPath/vscode/extensions-cursor-wsl.json ~/.cursor-server/extensions/extensions.json
...
If an extension doesn't work but you have access to the VSIX file, simply uninstall the extension and install it from the VSIX file.